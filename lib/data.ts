...
export const SITE = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://aitzaazhussain.vercel.app",
};
...
export const SOCIALS = [
  ...
  {
    label: "Upwork",
    href: "https://www.upwork.com/freelancers/~017909d227afb10dfb",
  },
...
export const WHY_CARDS = [
  {
    ...
    desc: "Clear, proactive updates at every stage. You'll never be left wondering what's happening with your project.",
    color: "#2563EB",
  },
  {
    icon: "TrendingUp",
    title: "Business Focused",
    desc: "Every technical decision ties back to your goals: conversions, efficiency, or growth — not just clean code.",
    color: "#14B8A6",
  },
  {
    icon: "Clock",
    title: "Reliable Delivery",
    desc: "Honest timelines, respected deadlines, and transparent scope management — no surprises after kick-off.",
    color: "#8B5CF6",
  },
  {
    icon: "HeartHandshake",
    title: "Long-Term Support",
    desc: "I don't disappear after launch. Post-launch support, iterations, and scaling are built into how I work.",
    color: "#F59E0B",
  },
] as const;
...
export const TIMELINE = [
  {
    ...
    desc: "Began building real projects — websites and small business systems — rather than tutorials.",
  },
  {
    year: "2023",
    title: "Shopify Specialization",
    desc: "Expanded into Shopify development and custom theme engineering.",
  },
  {
    year: "2024",
    title: "Full Stack + AI",
    desc: "Adopted Next.js, Supabase, and AI APIs to build more capable, data-driven products.",
  },
  {
    year: "2025+",
    title: "Independent Practice",
    desc: "Running freelance development as a professional practice — full builds for real local businesses, end to end.",
  },
];
...
export const SERVICES = [
  {
    ...
    desc: "Custom web applications built with React, Next.js, Node.js, and Supabase — scalable, performant, and production-ready.",
    benefits: [
      "React & Next.js",
      "REST & GraphQL APIs",
      "Database Design",
  ...
  },
  {
    ...
    desc: "Custom Shopify stores, theme engineering, app integrations, and conversion optimization for e-commerce brands.",
    benefits: [
      "Custom Themes",
      "App Integration",
  ...
  },
  {
    ...
    desc: "Embed intelligent automation into your business — AI chatbots, content pipelines, and custom LLM-powered workflows.",
    benefits: [
      "OpenAI & LangChain",
      "Custom Chatbots",
      "Workflow Automation",
  ...
  },
  {
    ...
    desc: "Pixel-perfect interfaces designed for conversion — clean, intuitive, and built to match your brand identity.",
    benefits: [
      "Design Systems",
      "Figma to Code",
      "Accessibility",
  ...
  },
  {
    ...
    desc: "Technical SEO audits, Core Web Vitals optimization, and structured data implementation to rank and convert.",
    benefits: [
      "Technical SEO",
      "Core Web Vitals",
      "Schema Markup",
  ...
  },
  {
    ...
    desc: "Connect your stack — payment gateways, CRMs, marketing tools, and third-party APIs integrated seamlessly.",
    benefits: [
      "Payment Systems",
      "CRM Integration",
      "Webhook Automation",
...
export const PROCESS_STEPS = [
  {
    ...
    desc: "A 30-minute call to understand your business, goals, technical requirements, timeline, and budget — no hard sell.",
    icon: "MessageCircle",
  },
  {
    n: "02",
    title: "Strategy & Planning",
    desc: "A detailed proposal: scope of work, architecture choices, milestones, and timeline — agreed before development starts.",
    icon: "Layers",
  },
  {
    n: "03",
    title: "Development",
    desc: "Iterative development with regular previews. You see progress every week and give feedback before final delivery.",
    icon: "Code2",
  },
  {
    n: "04",
    title: "Testing & Launch",
    desc: "Full QA across devices and browsers, performance testing, and a structured go-live process with zero downtime.",
    icon: "Rocket",
  },
  {
    n: "05",
    title: "Support & Growth",
    desc: "Post-launch support, bug fixes, feature iterations, and strategic advice as your business grows and needs evolve.",
    icon: "TrendingUp",
  },
] as const;
...
export const EXPERIENCE = [
  {
    ...
    achievements: [
      ...
      "Full-stack, Shopify & AI capability",
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    problem:
      "[Add: what problem did Al Madina Fast Food have before this site/system — e.g. no online presence, no way for customers to see the menu or place orders?]",
    research:
      "[Add: what you learned about their customers, competitors, or ordering habits before building.]",
    planning:
      "[Add: the scope you agreed on and why — e.g. menu display, WhatsApp/phone ordering, branch info.]",
    design:
      "[Add: key UI/UX decisions specific to this client — menu layout, mobile-first ordering flow, etc.]",
    development:
      "[Add: what was actually built — pages, features, integrations.]",
  ...
  },
  {
    ...
    tags: ["React", "Full Stack"],
    problem:
      "[Add: what problem did Al Baik Savour & BBQ have before this build?]",
  ...
  },
  {
    ...
    tags: ["React", "Full Stack"],
    problem:
      "[Add: what problem did Taj Mahal Banquet & Shadi Hall have — e.g. no way for prospective clients to see the venue or check availability?]",
    research: "[Add: research/market context for this client.]",
    planning:
      "[Add: agreed scope — gallery, booking inquiry form, package details, etc.]",
    design:
      "[Add: key design decisions — gallery-led layout for a venue, for example.]",
    development: "[Add: what was actually built.]",
    technologies: ["Next.js", "Tailwind CSS"],
    features: ["[Add real feature]", "[Add real feature]"],
    challenges: "[Add: a real obstacle on this build.]",
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    color: "#10B981",
    excerpt:
      "Mobile checkout friction is quietly costing DTC brands revenue. Here are the fixes that move the needle.",
    body: [
  ...
  },
  {
    ...
    color: "#8B5CF6",
    excerpt:
      "You do not need to train models to ship useful AI features. A practical guide to API-first AI integration.",
    body: [
  ...
  },
  {
    ...
    title:
      "The Discovery Call Checklist: What to Ask Before Hiring a Developer",
    category: "Business",
    readTime: "4 min",
    date: "2025-04-02",
    ...
    color: "#2563EB",
    excerpt:
      "The questions that separate a good client-developer fit from a project that goes sideways.",
    body: [
...
export const QUICK_CONTACT_ACTIONS = [
  ...
  },
  {
    ...
    icon: "Upwork",
    href: SOCIALS.find((s) => s.label === "Upwork")?.href || "",
    external: true,
  },
  {
